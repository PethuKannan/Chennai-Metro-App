...
public class Graph_M {
	...
	public void display_Map() {
		System.out.println("\tChennai  Metro Information system");
		System.out.println("\t------------------");
		System.out.println("----------------------------------------------------\n");
		ArrayList<String> keys = new ArrayList<>(vtces.keySet());
	...
	public static void Create_Metro_Map(Graph_M g) {
		...
		g.addVertex("Washermenpet Metro");
		...
		g.addVertex("Park Town");
		g.addVertex("Chintadripet");
		g.addVertex("Chepauk");
		g.addVertex("Thiruvallikeni");
		g.addVertex("Light House");
		g.addVertex("Mundaikanniamman kovil");
		g.addVertex("Thirumayilai");
		g.addVertex("Mandaveli");
		g.addVertex("Greenways Road");
		g.addVertex("Kotturpuram");
		g.addVertex("Kasturibai nagar");
		g.addVertex("Indira nagar");
		g.addVertex("Thiruvanmiyur");
		g.addVertex("Taramani");
		g.addVertex("Perungudi");
		g.addVertex("Velachery");
		g.addVertex("puluthivakkam");
		g.addVertex("Adambakkam");

		g.addEdge("Korattur", "Padi", 2);
		g.addEdge("Padi", "Villivakkam", 3);
		g.addEdge("Padi", "Anna Nagar West", 4);
		g.addEdge("Villivakkam", "Perambur Loco Works", 5);
		g.addEdge("Perambur Loco Works", "Perambur Carriage Works", 3);
		g.addEdge("Perambur Carriage Works", "Perambur", 3);
		g.addEdge("Perambur", "Vyasarpadi Jeeva", 4);
		g.addEdge("Vyasarpadi Jeeva", "Korukkupet", 5);
		g.addEdge("Korukkupet", "Basin Bridge", 5);
		g.addEdge("Vyasarpadi Jeeva", "Basin Bridge", 3);
		g.addEdge("Basin Bridge", "Chennai Central", 3);
		g.addEdge("Basin Bridge", "Washermenpet Metro", 3);
		g.addEdge("Korukkupet", "Washermenpet Metro", 2);
		g.addEdge("Vyaarpadi Jeeva", "Washermenpet Metro", 3);
		g.addEdge("Washermenpet Metro", "Royapuram", 3);
		g.addEdge("Royapuram", "Chennai Beach", 3);
		g.addEdge("Chennai Beach", "Park", 2);
		g.addEdge("Park", "Chetpet", 3);
		g.addEdge("Chetpet", "Nungambakkam", 4);
		g.addEdge("Nunagmbakkam", "Kodambakkam", 3);
		g.addEdge("Kodambakkam", "Mambalam", 3);
		g.addEdge("Mambalam", "Saidapet", 3);
		g.addEdge("Saidapet", "Guindy", 4);
		g.addEdge("Guindy", "St. Thomas Mount", 3);
		g.addEdge("St. Thomas Mount", "Pazhavanthangal", 2);
		g.addEdge("Airport", "Meenambakam Metro", 1);
		g.addEdge("Meenambakam Metro", "Nanganallur Road", 3);
		g.addEdge("Nanganallur Road", "Alandur", 2);
		g.addEdge("Alandur", "St. Thomas Mount", 2);
		g.addEdge("Alandur", "Guindy", 6);
		g.addEdge("Guindy", "Little Mount", 4);
		g.addEdge("Little Mount", "Saidapet Metro", 4);
		g.addEdge("Saidapet Metro", "Nandanam", 6);
		g.addEdge("Nandanam", "Tenampet", 4);
		g.addEdge("Tenampet", "AG-DMS", 1);
		g.addEdge("AG-DMS", "Thousand Lights", 4);
		g.addEdge("Thousand Lights", "LIC", 2);
		g.addEdge("LIC", "Government estate", 2);
		g.addEdge("Government estate", "Chennai Central", 3);
		g.addEdge("Chennai Central", "High Court", 2);
		g.addEdge("High Court", "Mannadi", 1);
		g.addEdge("Chennai Beach", "Chennai Fort", 3);
		g.addEdge("Chennai Fort", "Park Town", 2);
		g.addEdge("Park Town", "Chintadripet", 3);
		g.addEdge("Chintadripet", "Chepauk", 2);
		g.addEdge("Chepauk", "Thiruvallikeni", 1);
		g.addEdge("Thiruvallikeni", "Light House", 2);
		g.addEdge("Light House", "Mundaikanniamman kovil", 2);
		g.addEdge("Mundaikanniamman kovil", "Thirumayilai", 1);
		g.addEdge("Thirumayilai", "Mandaveli", 1);
		g.addEdge("Mandaveli", "Greenways Road", 2);
		g.addEdge("Greenways Road", "Kotturpuram", 5);
		g.addEdge("Kotturpuram", "Kasturibai nagar", 2);
		g.addEdge("Kasturibai nagar", "Indira nagar", 2);
		g.addEdge("Indira nagar", "Thiruvanmiyur", 2);
		g.addEdge("Thiruvanmiyur", "Taramani", 4);
		g.addEdge("Taramani", "Perungudi", 2);
		g.addEdge("Perungudi", "Velachery", 5);
		g.addEdge("Velachery", "puluthivakkam", 7);
		g.addEdge("puluthivakkam", "Adambakkam", 2);
		g.addEdge("Adambakkam", "St. Thomas Mount", 2);
